...
namespace Assignment_Nidhi
{
    class Assignment003
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                int choice = UserInterfaceConsole.GetNumber(menu);
        ...
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the Value to Find its root");
            Console.WriteLine("The SquareRoot value: " + Math.Sqrt(fValue));
        }

        private static void squareOperation()
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the Value to square");
            Console.WriteLine("The Square value: " + (fValue * fValue));
        }

        private static void divideOperation()
        {
            double fValue = UserInterfaceConsole.GetDouble("Enter the First Value");
            double sValue = UserInterfaceConsole.GetDouble("Enter the Second Value");
